...
cd ~/Actions-OpenWrt/openwrt

git checkout v21.02.3

./scripts/feeds update -a && ./scripts/feeds install -a

cp ~/Actions-OpenWrt/patch/652-netfilter-flow_offload-add-check-ifindex.patch target/linux/generic/hack-5.4/
...
#cp ~/Actions-OpenWrt/19_cpu.js ~/Actions-OpenWrt/openwrt/feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/
...
cp -r files ~/Actions-OpenWrt/openwrt/
popd
...
cd ~/Actions-OpenWrt/openwrt
cp ~/Actions-OpenWrt/sh/scripts/02-remove_upx.sh ./
cp ~/Actions-OpenWrtsh/scripts/03-convert_translation.sh ./
cp ~/Actions-OpenWrt/sh/scripts/04-create_acl_for_luci.sh ./
...
cp ~/Actions-OpenWrt/conf/nginx.config ~/Actions-OpenWrt/openwrt/
cp ~/Actions-OpenWrt/conf/config-5.4 ~/Actions-OpenWrt/openwrt/target/linux/x86/
mv nginx.config .config

#添加kmod-inet-diag支持
cp ~/Actions-OpenWrt/conf/inet-diag ./
